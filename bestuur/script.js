...
(function(){
  /* De .reveal-CSS op deze pagina stond al klaar maar had geen bijbehorend script.
     Dit activeert 'm zonder externe library (GSAP wordt geblokkeerd in de Stroomlijn-omgeving). */
